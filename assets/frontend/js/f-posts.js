...
async function loadFrontendConfig() {
  try {
    ...
    console.warn('⚠️ Config load error, using defaults:', err);
    frontendConfig = getDefaultConfig();
  }
...
console.log('✅ f-posts.js loaded — with pagination + settings');